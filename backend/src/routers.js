...
router.post('/users', (req, res) => {
    ...
    let errors = []
        readUsers().then((usersDB) => {
        if (userPassword.name && userPassword.password && userPassword.email) {
        usersDB.push(userPassword)
        writeUsers(usersDB)
...
router.post('/auth', (req, res) => {
    ...
    email: req.body.email, 
    password: req.body.password } 
        bcrypt.hash(userAuth.password, saltRounds, function (err, hash) {
        userAuth.password = hash
        usersDB.push(userAuth)
